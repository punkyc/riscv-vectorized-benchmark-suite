...
_MMR_MASK_i64 xMask;
  ...
  x = _MM_VFCVT_F_X_f64(_MM_AND_i64(_MM_VFCVT_X_F_i64(x, gvl), _ps_inv_sign_mask,gvl), gvl);
  ...
  emm0 = _MM_SLL_i64(emm0, _MM_VINTERPRET_i64_u64(_MM_SET_i64(61,gvl)),gvl);
  ...
  _MMR_f64 sign_bit =  _MM_VFCVT_F_X_f64(emm0, gvl);
  _MMR_f64 poly_mask =  _MM_VFCVT_F_X_f64(emm2, gvl);
  ...
  xmm3 = poly_mask;
  y2 = _MM_VFCVT_F_X_f64(_MM_AND_i64(_MM_VFCVT_X_F_i64(xmm3, gvl), _MM_VFCVT_X_F_i64(y2, gvl) , gvl), gvl); //, xmm3);
  y = _MM_VFCVT_F_X_f64(_MM_AND_i64(_MM_XOR_i64(_MM_VFCVT_X_F_i64(xmm3, gvl), _MM_SET_i64(0xffffffffffffffff,gvl),gvl),_MM_VFCVT_X_F_i64(y, gvl),gvl), gvl);   
  y = _MM_ADD_f64(y, y2 ,gvl);
  /* update the sign */
  y = _MM_VFCVT_F_X_f64(_MM_XOR_i64(_MM_VFCVT_X_F_i64(y, gvl), _MM_VFCVT_X_F_i64(sign_bit, gvl) , gvl), gvl);
...
_MMR_MASK_i32 xMask;
  /* take the absolute value */
  x = _MM_VFCVT_F_X_f32(_MM_AND_i32(_MM_VFCVT_X_F_i32(x, gvl), _ps_inv_sign_mask,gvl), gvl);
  ...
  emm0 = _MM_SLL_i32(emm0, _MM_VINTERPRET_i32_u32(_MM_SET_i32(29,gvl)),gvl);
  ...
  _MMR_f32 sign_bit =  _MM_VFCVT_F_X_f32(emm0, gvl);
  _MMR_f32 poly_mask =  _MM_VFCVT_F_X_f32(emm2, gvl);
  ...
  /* select the correct result from the two polynoms */
  xmm3 = poly_mask;
  y2 = _MM_VFCVT_F_X_f32(_MM_AND_i32(_MM_VFCVT_X_F_i32(xmm3, gvl), _MM_VFCVT_X_F_i32(y2, gvl) , gvl), gvl); //, xmm3);
  y = _MM_VFCVT_F_X_f32(_MM_AND_i32(_MM_XOR_i32(_MM_VFCVT_X_F_i32(xmm3, gvl), _MM_SET_i32(0xffffffff,gvl),gvl),_MM_VFCVT_X_F_i32(y, gvl),gvl), gvl);   
  y = _MM_ADD_f32(y, y2 ,gvl);
  /* update the sign */
  y = _MM_VFCVT_F_X_f32(_MM_XOR_i32(_MM_VFCVT_X_F_i32(y, gvl), _MM_VFCVT_X_F_i32(sign_bit, gvl) , gvl), gvl);
