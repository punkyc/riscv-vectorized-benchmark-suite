...
_MMR_i64  tmp3;
        ...
        imm0  = _MM_SLL_i64(imm0,  _MM_VINTERPRET_i64_u64(_MM_SET_i64(52,gvl)),gvl);

        tmp4 = _MM_VFCVT_F_X_f64(imm0,gvl);
...
_MMR_i32  tmp3;
        ...
        imm0  = _MM_SLL_i32(imm0, _MM_VINTERPRET_i32_u32(_MM_SET_i32(23,gvl)),gvl);

        tmp4 = _MM_VFCVT_F_X_f32(imm0,gvl);
